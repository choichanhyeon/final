		...
		<nav class="navbar bg-white border">
			<div class="d-flex justify-content-center mx-auto">
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span id="headerSearchSubmitButton"
								...
								class="fas fa-search" onclick=";"></i></span>
						</div>

						<input id="search" class="form-control bg-light" type="text"
							name="search" value="${search}" placeholder="검색">

						<div class="input-group-append">
							<span id="headerSearchSubmitButton"
								class="input-group-text bg-light"><i
								class="fas fa-times-circle" onclick=";"></i></span>
						</div>
					</div>
				</form>
				...
				<ul class="navbar-nav list-group-horizontal ml-5">
					<li class="nav-item">
						<h4 class="mx-2">
							<a class="nav-link" href="/feed/feed"><i class="fas fa-home"></i></a>
						</h4>
					</li>
					<li class="nav-item">
						<h4 class="mx-2">
							<a class="nav-link" href="/dm/dm"><i
								class="far fa-paper-plane"></i></a>
						</h4>
					</li>
					<li class="nav-item">
						<h4 class="mx-2">
							<a class="nav-link" href="/feed/feed"><i
								class="far fa-compass"></i></a>
						</h4>
					</li>
					<li class="nav-item">
						<h4 class="mx-2">
							<a class="nav-link" href="/feed/feed"><i class="far fa-heart"></i></a>
						</h4>
					</li>
					<li class="nav-item">
						<h4 class="mx-2">
							<a class="nav-link" href="/member/profile"> <c:choose>
									<c:when
										test="${not empty sessionLoginMemberProfile.member_img_server_name}">
										<div
											class="rounded-circle border border-dark  w-26 h-26 overflow-hidden">
											<img id="header_profile_image"
